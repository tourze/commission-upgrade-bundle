...
use Tourze\CommissionUpgradeBundle\Controller\Admin\ManualUpgradeCheckController;
use Tourze\PHPUnitSymfonyWebTest\AbstractWebTestCase;

/**
 * ManualUpgradeCheckController 集成测试.
 *
 * @internal
 */
#[CoversClass(ManualUpgradeCheckController::class)]
#[RunTestsInSeparateProcesses]
final class ManualUpgradeCheckControllerTest extends AbstractWebTestCase
{
    private ReflectionClass $reflection;

    protected function onSetUp(): void
    {
        $this->reflection = new ReflectionClass(ManualUpgradeCheckController::class);
    }
    ...
    public function testControllerExtendsAbstractController(): void
    {
        $this->assertTrue(
            ...
            'ManualUpgradeCheckController 必须继承 AbstractController'
        );
    }
    ...
    public function testControllerIsNotAbstract(): void
    {
        $this->assertFalse(
            ...
            'ManualUpgradeCheckController 不能是抽象类'
        );
    }
