...
use Tourze\CommissionUpgradeBundle\Controller\Admin\ManualUpgradeExecuteController;
use Tourze\PHPUnitSymfonyWebTest\AbstractWebTestCase;

/**
 * ManualUpgradeExecuteController 集成测试.
 *
 * @internal
 */
#[CoversClass(ManualUpgradeExecuteController::class)]
#[RunTestsInSeparateProcesses]
final class ManualUpgradeExecuteControllerTest extends AbstractWebTestCase
{
    private ReflectionClass $reflection;

    protected function onSetUp(): void
    {
        $this->reflection = new ReflectionClass(ManualUpgradeExecuteController::class);
    }
    ...
    public function testControllerExtendsAbstractController(): void
    {
        $this->assertTrue(
            ...
            'ManualUpgradeExecuteController 必须继承 AbstractController'
        );
    }
    ...
    public function testControllerIsNotAbstract(): void
    {
        $this->assertFalse(
            ...
            'ManualUpgradeExecuteController 不能是抽象类'
        );
    }
